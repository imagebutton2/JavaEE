...
import com.gjz.travel.dao.impl.UserDaoImpl;
import com.gjz.travel.domain.User;
import com.gjz.travel.service.UserService;
import com.gjz.travel.util.MailUtils;
import com.gjz.travel.util.UuidUtil;
...
public class UserServiceImpl implements UserService {
    ...
    public boolean regist(User user) {
        ...
        //邮件的内容
        String content = "您的邮箱尚未激活,请<a href='http://101.132.101.227:8080/travel/user/active?code="+user.getCode()+"'>点击激活</a>" ;
